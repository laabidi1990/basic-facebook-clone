        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="w-56 h-8 pl-8 bg-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-6 border-b-2 h-full border-blue-500 flex items-center">
            ...
            <router-link to="/" class="px-6 h-full border-white flex items-center">
                <img src="https://img-0.journaldunet.com/M0Rry_97U_EnJy_IGrIeoxkRFUY=/1280x/smart/7cfa455788b7461ea1782b0b72e31c8f/ccmcms-jdn/2383369.jpg"
                    alt="profile image for user" class="w-9 h-9 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 h-full border-white flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5">
